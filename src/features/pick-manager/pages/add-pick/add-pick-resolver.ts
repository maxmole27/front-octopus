...
export const pickResolver = z.object({
  ...
  bet_status_id: z
    .number({
      required_error: 'El estado de la apuesta es requerido',
    })
    .min(1, { message: 'El estado de la apuesta es requerido' }),
})
